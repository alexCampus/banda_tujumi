                ...
                @else
                    <form name="sentMessage" id="contactForm" method="POST" action="/contact" novalidate>
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="email" class="form-control" placeholder="Votre Email" id="email" name="email" required
                                       data-validation-required-message="Veuillez entrer une adresse email valide.">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="tel" class="form-control" placeholder="Votre Numéro de Téléphone" id="phone" name="phonenumber" required
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Message</label>
                                <textarea rows="5" class="form-control" placeholder="Votre Message" id="message" name="message" required
